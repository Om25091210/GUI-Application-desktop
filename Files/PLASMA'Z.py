...
def pro(x=0):
    ...
    def snt(x=0):                 #####################################'cos' series of canvas and p_img of image:)
        ...
        cos.place(x=0,y=0)
        p_img=PhotoImage(file="####################")###SNP2
        cos.create_image(300,200,anchor=N,image=p_img)
        p_img1=PhotoImage(file="#######################")#LOGO
        ...
        def e1(x=0):
            ur1=StringVar()
            use1=Entry(root1,textvariable=ur1,bg="black",fg="yellow",width=25,show='*')
            use1.place(x=630,y=300)
            use1.config(font=("Corbel",15))
            use1.focus()
        ur=StringVar()
        use=Entry(root1,textvariable=ur,bg="black",fg="yellow",width=25)
        ...
        u1=StringVar()
        us1=Entry(root1,textvariable=u1,bg="black",fg="yellow",width=25)
        us1.place(x=630,y=300)
        us1.config(font=("Corbel",15))
        ####_________________________________________________________ LABELS
        usl=Label(root1,text=" USERNAME :",bg="black",fg="yellow")
        usl.place(x=505,y=220)
        usl.config(font=("Algerian",15))
       
        options=["6TH","7TH","8TH","9TH","10TH","11TH","12TH"]
        copp=StringVar()
        copp.set("CLASS")
        cop=OptionMenu(root1,copp,*options)                    ################# the star means individual options and  the get function helps inside a function not below the option menu
        ...
        copp2=StringVar()
        copp2.set("SUBJECT")
        cop2=OptionMenu(root1,copp2,*options2)
        cop2.place(x=730,y=385)
        cop2.config(font=("Algerian",17))
        
        pas=Label(root1,text=" PASSWORD :",bg="black",fg="yellow")
        ...
        l=Button(root1,text="LOG IN",bg="gray7",fg="yellow",command=l1)
        l.place(x=660,y=450)
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$44
        def dt():
            ...
            s3.place(x=0,y=0)
            my_image11=PhotoImage(file='##########################')###SC6
